    ...
    <PageWrapper>
      <section className={aboutStyles.about}>
        ...
        <div className={aboutStyles.aboutText}>
          ...
          <p>
            I’m <strong>Chidinma Anyanwu</strong>, a web developer based in
            Lagos, Nigeria. I specialize in building{" "}
            <strong>responsive and interactive web applications</strong> using{" "}
            <strong>
              HTML, CSS, Tailwind, Bootstrap, JavaScript, and React
            </strong>
            ...
            completed projects like a React FAQ Accordion and multi-day
            interactive components including carousels and charts. I’m
            passionate about turning ideas into real-world digital experiences
            and continuously improving my skills to deliver{" "}
            <strong>clean, efficient, and user-friendly solutions</strong>. I
            aspire to work on projects that challenge me, help businesses grow,
