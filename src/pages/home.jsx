        ...
        <div className={styles.container}>
          ...
          <div className={styles.heroText}>
            ...
            <p className="text-[1rem] leading-6 text-gray-600 mt-4">
              ...
              user-friendly and visually appealing front-end applications. I
              enjoy turning ideas into responsive, functional, and accessible
              web experiences while continuously improving my skills and
